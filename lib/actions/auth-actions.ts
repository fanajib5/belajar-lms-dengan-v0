...
export async function signUpAction(formData: FormData) {
  ...
  try {
    ...
    return { success: false, error: error.message || "Gagal mendaftar. Silakan coba lagi." }
  }
}
...
export async function signInWithOtpAction(formData: FormData) {
  ...
  try {
    ...
    return { success: false, error: error.message || "Gagal mengirim kode OTP. Silakan coba lagi." }
  }
}
...
export async function verifyOtpAction(formData: FormData) {
  ...
  try {
    ...
    return {
      success: false,
      error: error.message || "Kode OTP tidak valid atau telah kedaluwarsa. Silakan coba lagi.",
    }
  }
}
...
export async function resetPasswordAction(formData: FormData) {
  ...
  try {
    ...
    return {
      success: false,
      error: error.message || "Gagal mengirim instruksi reset password. Silakan coba lagi.",
    }
  }
}
...
export async function updatePasswordAction(formData: FormData) {
  ...
  try {
    ...
    return { success: false, error: error.message || "Gagal memperbarui password. Silakan coba lagi." }
  }
}
...
export async function signOutAction() {
  ...
  try {
    ...
    return { success: false, error: error.message || "Gagal keluar. Silakan coba lagi." }
  }
}
...
export async function getProfileAction(userId: string) {
  ...
  try {
    ...
    return { success: false, error: error.message || "Gagal mengambil profil. Silakan coba lagi." }
  }
}
